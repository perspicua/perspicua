 ...
 */
#define PANIC(msg) panic_full((msg), __FILE__, __LINE__, (unsigned long)__builtin_frame_address(0), (void*)0)
 ...
 */
#define PANIC_TF(msg, tf) panic_full((msg), __FILE__, __LINE__, (unsigned long)__builtin_frame_address(0), (tf))
...
#define ASSERT(cond)                                                                                               \
    ...
    {                                                                                                              \
        ...
        {                                                                                                          \
            panic_full(                                                                                            \
                "ASSERT failed: " #cond, __FILE__, __LINE__, (unsigned long)__builtin_frame_address(0), (void*)0); \
        }                                                                                                          \
    } while (0)
