...
static struct vnode* devfs_root_vnode = (void*)0;
...
static struct vnode_ops devfs_root_ops = {.lookup = devfs_root_lookup, .read = (void*)0, .write = (void*)0};
...
static struct vnode_ops devfs_tty_ops = {.read = devfs_tty_read, .write = devfs_tty_write, .lookup = (void*)0};
